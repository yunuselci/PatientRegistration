...
<head>
    ...
    <title><s:message code="msg.updatepatient"/></title>
...
<div class="container my-5">
    <h3><s:message code="msg.updatepatient"/></h3>
    <div class="card">
        <div class="card-body">
            <div class="col-md-8">
                <form:form method="post" action="/update/${patient.id}" modelAttribute="patient">
                    <div class="row">
